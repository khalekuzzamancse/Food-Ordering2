...
public class DatabaseFetch implements FirebaseCustom {
    ...
    CallbackUploadImage callbackUploadImage;
    ...
    OnCompleteListener<UploadTask.TaskSnapshot> callbackUpload = new OnCompleteListener<UploadTask.TaskSnapshot>() {
        @Override
    ...
    public void uploadImage(String path, String fileName, Uri imageUri, CallbackUploadImage callbackUploadImage) {
        storage = FirebaseStorage.getInstance();
        this.callbackUploadImage = callbackUploadImage;
        FirebaseStorage storage = FirebaseStorage.getInstance();
        reference = storage.getReference().child(path).child(fileName);
        reference.putFile(imageUri).addOnCompleteListener(callbackUpload);
